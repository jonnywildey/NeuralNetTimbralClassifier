...
import com.neuralNet.pattern.WavePatternsRegenerate;
import com.riff.*;
...
public class Conversion {
	...
	public static void main(String[] args) {
		...
		regeneratePatterns(combineDir, waveSerial);
	...
	/** regenerates the FFT analysis for a folder. Multithreaded, make sure the call method is right **/
