...
public class EQFilter {
	 ...
	 * @return the signal
	 */
	public static Signal bandPassFilter(Signal signal, double centreFreq,
			double octaveBW) {
		// set up arrays
	 ...
	 * @return the signal
	 */
	public static Signal EQ(Signal signal, double centreFreq, double octaveBW,
			double gain) {
		// set up arrays
		double[][] os = signal.getSignal();
		double[][] ns = new double[os.length][os[0].length];
		PeakEQ bf = new PeakEQ(signal.getSampleRate(), centreFreq, octaveBW,
				gain);
	 ...
	 * @return the signal
	 */
	public static Signal EQSweep(Signal signal, double centreFreq, double to,
			double octaveBW, double gain) {
		// set up arrays
		double[][] os = signal.getSignal();
		double[][] ns = new double[os.length][os[0].length];
		PeakEQ bf = new PeakEQ(signal.getSampleRate(), centreFreq, octaveBW,
		...
		for (int i = 0; i < os.length; ++i) {
			for (int j = 0; j < os[0].length; ++j) {
				// Process
				if (j % dt == 0) {
					freq = centreFreq + ((j + 1) / (double) (os[0].length + 1))
					* (to - centreFreq);
	 ...
	 * @return the signal
	 */
	public static Signal highPassFilter(Signal signal, double centreFreq,
			double resonance) {
		// set up arrays
		double[][] os = signal.getSignal();
		double[][] ns = new double[os.length][os[0].length];
		HighPass bf = new HighPass(signal.getSampleRate(), centreFreq,
				resonance);
	 ...
	 * @return the signal
	 */
	public static Signal lowPassFilter(Signal signal, double centreFreq,
			double resonance) {
		// set up arrays
		double[][] os = signal.getSignal();
		double[][] ns = new double[os.length][os[0].length];
	 ...
	 * @return the signal
	 */
	public static Signal notch(Signal signal, double centreFreq, double octaveBW) {
		// set up arrays
		double[][] os = signal.getSignal();
		double[][] ns = new double[os.length][os[0].length];
