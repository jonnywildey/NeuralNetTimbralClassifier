...
public class HTML {
	...
	public static void arrayStringer(String[][] str) {
		/*
		 * Formats a 2D array to html. i.e. adds <br> Then displays it
		 */
	...
	public static JFrame makeFrameAndReturn(JScrollPane window) {
		...
		// ((int)screenSize.getHeight() / 6), (int)(screenSize.getWidth() *
		// 0.6), (int)(screenSize.getHeight() * 0.6));
		frame.setBounds((int) (screenSize.getWidth() / 20),
	...
	public static String tableColumner(String[][] items) {
		/*
		 * surprisingly useful 2darray to html table thing. Have swapped round
		 * column and table values so this makes sense with arrays. (if you
		 * think about it html tables treat rows as the index) if you REALLY
	...
	public static void winDisplay(String text) {
		/*
		 * displays an HTML string in a JPanel. Hopefully correctly
		 */
